     ...
     relative overflow-hidden">
      ...
      items-center overflow-hidden">
        ...
        <div className="flex-center flex-col sm:px-10">
         <div className="relative h-[50vh] w-full flex imes-center">
          <video playsInLine id="explorVideo" 
          className="w-full h-full object-cover object-center" preload="none"> 
            <source src={exploreVideo} type="video/mp4" /*muted */
          ...
          <div className="flex flex-col w-full relative ">
            ...
            <div className="feature-video-container">
              <div className="overflow-hidden flex-1 h-[50vh]">
                <img src={exploreImg} alt="titanium" className="feature-video g_grow" />
              </div> 
              <div className="overflow-hidden flex-1 h-[50vh]">
