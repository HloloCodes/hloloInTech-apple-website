...
import { animateWithGsap } from '@/utils/animations'; // Make sure this is imported correctly
...
const Features = () => {
  ...
  useEffect(() => {
    ...
    gsap.to('#exploreVideo', {
      ...animationProps, // Ensure animationProps is defined somewhere in your code
      scrollTrigger: {
        trigger: '#exploreVideo',
        toggleActions: 'play pause reverse restart',
        start: '-10% bottom',
        ...scrollProps, // Ensure scrollProps is defined somewhere in your code
      },
      onComplete: () => {
